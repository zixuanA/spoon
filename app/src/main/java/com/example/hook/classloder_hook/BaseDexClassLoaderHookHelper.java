package com.example.hook.classloder_hook;
...
//        Object o = constructor.newInstance(apkFile, false, apkFile, DexFile.loadDex(apkFile.getCanonicalPath(), optDexFile.getAbsolutePath(), 0));
        Constructor<?> constructor = elementClass.getConstructor(DexFile.class);
        Object o = constructor.newInstance( DexFile.loadDex(apkFile.getCanonicalPath(), optDexFile.getAbsolutePath(), 0));
